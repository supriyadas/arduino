...
#define NUM_NEOPIXELS    45    // The amount of NeoPixels
#define BRIGHTNESS       60    // 0-150. Pixel brightness. NeoPixels (RGBW) can be really(!) bright, so I set this low. Increase if needed.
...
Adafruit_NeoPixel pixels = Adafruit_NeoPixel(NUM_NEOPIXELS, NEOPIXEL_PIN,NEO_GRB + NEO_KHZ800); // This setup is for a NeoPixel GRBW Ring with 16 LEDs
